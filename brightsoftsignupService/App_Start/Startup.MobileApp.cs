...
namespace brightsoftsignupService
{
    ...
    public class brightsoftsignupInitializer : CreateDatabaseIfNotExists<brightsoftsignupContext>
    {
        protected override void Seed(brightsoftsignupContext context)
        {
