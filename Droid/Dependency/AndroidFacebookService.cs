...
namespace SignUp.Droid.Dependency
{
	public class AndroidFacebookService : Java.Lang.Object, IFacebookService, GraphRequest.IGraphJSONObjectCallback, GraphRequest.ICallback, IFacebookCallback
	{
        ...
        SignUp.FacebookHelper.LoginResult _loginResult;
		TaskCompletionSource<SignUp.FacebookHelper.LoginResult> _completionSource;
		...
		public Task<SignUp.FacebookHelper.LoginResult> Login()
		{
			_completionSource = new TaskCompletionSource<SignUp.FacebookHelper.LoginResult>();
		...
		public void OnCompleted(GraphResponse response)
		{
			if (response?.JSONObject == null)
				_completionSource?.TrySetResult(new SignUp.FacebookHelper.LoginResult { LoginState = LoginState.Canceled });
			else
			{
				_loginResult = new SignUp.FacebookHelper.LoginResult
				{
		...
		{
			_completionSource?.TrySetResult(new SignUp.FacebookHelper.LoginResult
			{
