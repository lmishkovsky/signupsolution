...
[assembly: ExportRenderer(typeof(RootPage), typeof(Signup.Droid.Renderers.MainPageRenderer))]
namespace Signup.Droid.Renderers
{
    internal class MainPageRenderer : VisualElementRenderer<RootPage>, IOnTabClickListener
    {
        ...
        private void InitializeElement(RootPage element)
        {
            PopulateChildren(element);
        }

        private void PopulateChildren(RootPage element)
        {
        ...
        private void ClearElement(RootPage element)
        {
            if (_currentPage != null)
            {
